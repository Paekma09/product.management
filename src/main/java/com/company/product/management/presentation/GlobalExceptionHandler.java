...
import com.company.product.management.domain.EntityNotFoundException;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorMessage> handleConstrainViolatedException(ConstraintViolationException ex) {
        // 예외에 대한 처리
